...
// Export routes
router.get('/children/export', verifyFirebaseAuth, exportChildren);
router.get('/pregnant-women/export', verifyFirebaseAuth, exportPregnantWomen);
router.get('/adolescents/export', verifyFirebaseAuth, exportAdolescents);
